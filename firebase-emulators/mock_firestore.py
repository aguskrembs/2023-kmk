...
def wait_for_firestore(url, timeout=60):
    """Espera hasta que Firestore esté listo."""
    ...
    while time.time() - start_time < timeout:
        try:
            ...
            print("Esperando a Firestore...")
        time.sleep(5)
    raise TimeoutError("Firestore no está listo después de esperar {} segundos.".format(timeout))

if __name__ == "__main__":
    # Esperar hasta que Firestore esté listo
    wait_for_firestore("http://firebase-emulators:9099")
